          ...
          <div className="mb-12">
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                El PR no muere, pero pierde función estratégica al reducirse a ejecución táctica. Las organizaciones ganan visibilidad pero erosionan reputación. ¿Comunicar para salir hoy o sostener posición mañana?
              </p>
            </div>
          </div>
